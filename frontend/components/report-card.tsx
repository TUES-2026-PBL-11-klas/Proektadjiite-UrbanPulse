...
export function ReportCard({
  ...
  if (variant === "popup") {
    return (
      <div
        className={cn(
          "w-[320px] bg-card rounded-2xl border border-border/70 shadow-xl p-4",
          className,
        )}
      >
        <div className="pr-8">
          <div className="flex items-start gap-3.5 mb-3">
            ...
            <div className="min-w-0 flex-1">
              <h4 className="font-semibold text-[17px] leading-[1.25] tracking-tight line-clamp-2">
                {report.title}
              </h4>
        ...
        <Link
          ...
          className="flex items-center justify-center gap-1.5 w-full py-2.5 px-3 bg-forest text-white text-sm font-semibold rounded-xl hover:bg-forest/90 transition-colors"
        >
          Виж детайли
